...
################################################################################
## Form generated from reading UI file 'interfaceboYegt.ui'
##
...
"}")
        ...
        self.verticalLayout.addWidget(self.exitPrompt)
        ...
        self.mainPages = QStackedWidget(self.scrollAreaWidgetContents)
